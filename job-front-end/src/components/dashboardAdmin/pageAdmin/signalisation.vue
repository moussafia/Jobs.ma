<template>
  <div id="signalisation">
    <h3 class="i-name">Signalisation</h3>

    <div class="overflow-x-auto sm:rounded-lg section-signal">
      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        >
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Nombre de signal</th>
          ...
          >
            ...
            >
              <img
                ...
                src="../../../assets/image/jobs/entr.png"
                alt="Jese image"
              />
              <div class="pl-3">
