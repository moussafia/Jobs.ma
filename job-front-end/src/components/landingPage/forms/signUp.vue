<template>
   <form id="form-sign-up"
        ...
        <div class="flex flex-col items-start">
          ...
          <input type="text" placeholder="First name" v-model="first_name" data-parsley-required
          data-parsley-pattern="^[a-zA-Z\s]+$"/>
          <label for="">Last name</label>
          <input type="text" placeholder="Last name" v-model="last_name" data-parsley-required
          data-parsley-pattern="^[a-zA-Z\s]+$"/>
          <label for="">Email</label>
          <input type="email" placeholder="email"  v-model="email" data-parsley-required />
          <label for="">Password</label>
          <input type="password" placeholder="Password" id="password"  v-model="password" data-parsley-required />
          <label for="">Confirmer password</label>
          <input type="password" placeholder="Confirmer password"   v-model="password_confirmation" 
          data-parsley-required data-parsley-equalto="#password" data-parsley-trigger="change"/>
        </div>
...
export default {
    ...
    methods:{
        fetchCsrfToken(){
            axios.get('http://localhost:8000/api/csrfToken')
            .then(response=>{
